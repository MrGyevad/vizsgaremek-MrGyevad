...
public class DogServiceTest {
    ...
    void init(){
        ...
        dog3 = new Dog(1, "Digi", 11, "Maltese", Gender.SIRE, LocalDateTime.now(), true, false, new BestFriend(1, null, null));
        ...
        dogInfo1 = new DogInfo(1, "Sirion", 6, "Mudi", Gender.SIRE, LocalDateTime.now(), true, false);
        dogInfo2 = new DogInfo(2, "Diego", 11, "Maltese", Gender.SIRE, LocalDateTime.now(), true, false);
        dogInfo3 = new DogInfo(1, "Digi", 11, "Maltese", Gender.SIRE, LocalDateTime.now(), true, false);
    }
